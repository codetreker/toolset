...
description: "How to call Claude Code for any task: coding, refactoring, code review, research, root cause analysis, or investigation. Covers exec parameters, timeout selection by task type, result handling, and cwd setup. Trigger: about to call Claude Code, need to set timeout, need to spawn Claude Code session."
---
